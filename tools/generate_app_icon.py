...
Colors are the Track theme's (the default): a black tile, a white G, a volt arrow. Pure Python
(math, zlib, struct), so it runs anywhere: python tools/generate_app_icon.py
"""
...
def main() -> int:
    ...
    write_svg()
    for path in (ICO, ANDROID_FOREGROUND, SVG):
